...
Public Sub Initialize (vCallback As Object, vEventName As String)
	...
	DefaultTextColor = Colors.Black					'nao faz diferença no projeto
	DefaultTextSize = 16
	DefaultTextBackgroundColor = Colors.Black		'nao faz diferença no projeto
	DefaultTextBackground = Colors.White			'nao faz diferença no projeto
End Sub
